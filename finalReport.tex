...
\usepackage{cite,url,hyperref,graphicx, amsmath}
\usepackage{alltt} 
\usepackage{listings}
\lstset{
...
\begin{tabular}{p{6.5cm}p{8.5cm}}
  ...
  \parbox[t]{5cm}{\texttt{genome2PSMC/}\\ \texttt{runDataCollection.sh}} & Runs PSMC with 4 different time intercals, does binary splitting up to 1024, takes summary statistics on the genome, extracts population dynamics in text files.\\ \hline  
