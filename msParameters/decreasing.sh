...
do
	...
	do			
		...
		~/Documents/SummerScholarship/foreign-master/msHOT-lite/msHOT-lite 2 1 -t 65130 -r 10973 $bpLength -eN 0.01 1 -eN 0.2 1.5 -eN 0.4 2 -eN 0.6 3 -eN 0.8 4 -eN 1 5 -eN 2 6 -eN 3 6 -l > $oldStringName'.ms'			
